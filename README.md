...
Then download and install an Image Detection Server. In this project we have used an implementation over Mask RCNN which you can clone and install from here, to do so, follow the instractions below.
